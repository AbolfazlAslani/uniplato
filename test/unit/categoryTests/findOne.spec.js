...
describe('CategoryController', () => {
    describe('findOneCategory', () => {
        it('should return a single category successfully', async () => {
            ...
            const findOneCategoryStub = sinon.stub(categoryService_1.default, 'findOneCategory').resolves(stubbedCategory);
            ...
            await category_controller_1.default.findOneCategory(requestMock, replyMock);
        ...
        it('should handle errors and return 500 status code', async () => {
            ...
            const findOneCategoryStub = sinon.stub(categoryService_1.default, 'findOneCategory').throws(new Error('Test error'));
            // Mock FastifyRequest and FastifyReply objects
            const requestMock = {
                params: { id: '1' }
            };
